...
interface ModalAdicionarProdutoProps {
  isOpen: boolean;
  onClose?: () => void;
  onAdicionar?: (produto: NovoProduto) => void;
}

const CATEGORIAS = ['Celulares', 'Notebooks', 'TVs', 'Acessórios', 'Outros'];

export default function ModalAdicionarProduto({ isOpen, onClose, onAdicionar }: ModalAdicionarProdutoProps) {
  ...
  const handleAdicionar = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Limpa o formulário
      setNome(''); setCategoria(''); setDescricao(''); setPreco(''); setEstoque(0); setImgUrl('');
  ...
  return (
    ...
    >
      ...
      <h2 className="font-black text-black text-2xl -mt-2">Adicionar Produto</h2>
